...
import { registerPersonalityCommands } from './ops/personality-command';
import { registerRunCommands } from './ops/run-command';
import { registerSandboxCommand } from './ops/sandbox-command';
import { registerSkillCommands } from './ops/skill-command';
...
import { formatBannerLine, printBanner, FLOPSY_VERSION } from './ui/banner';
import { attachHelpFormatter } from './ui/help-format';

const VERSION = FLOPSY_VERSION;
...
registerPersonalityCommands(program);
