...
export const SLASH_COMMANDS: readonly SlashCmd[] = [
    ...
    { name: 'insights',    description: 'view learned insights + proactive dashboard' },
    { name: 'audit',       description: 'static security scan (no LLM)' },
    { name: 'skills',      description: 'review + capture skills', argHint: '[list | proposed | propose | approve <name> | reject <name> | show <name>]' },
    { name: 'goal',        description: 'view / set / pause / resume the session goal', argHint: '[set <text> | pause | resume | clear]' },
    { name: 'subgoal',     description: 'layer extra criteria on the active /goal', argHint: '[<text> | list | remove <N> | clear]' },
    { name: 'cron',        description: 'list / trigger scheduled jobs', argHint: '[list | trigger <id> | stats <id>]' },
    { name: 'heartbeat',   description: 'list / trigger / stats on heartbeat jobs', argHint: '[list | trigger <name>]' },
    { name: 'improve',     description: 'manually run self-improve NOW (writes lessons to skills/proactive)' },
