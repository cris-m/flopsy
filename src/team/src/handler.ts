...
export class TeamHandler implements AgentHandler {
    ...
    constructor(config: TeamHandlerConfig) {
        ...
        // Resolves the incoming peer-routing-key (e.g. telegram:dm:123456789)
        // into an effective threadId carrying the active session
        // (telegram:dm:123456789#s-19834-4a7b9f1). Rotates on daily 4am
    ...
    async invoke(
        ...
        // PR 4: resolve the inbound peer-routing-key (e.g. telegram:dm:123456789)
        // into an effective threadId carrying the active session
        // (e.g. telegram:dm:123456789#s-19834-4a7b9f1). Daily-4am OR 24h-idle
