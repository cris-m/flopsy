...
when-to-use: "Use when investigating a topic on the open web at depth — multiple queries, source diversity, and iterative refinement."
metadata:
  flopsy:
    agent-affinity: [legolas, saruman]
---
