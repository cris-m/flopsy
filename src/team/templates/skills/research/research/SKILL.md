...
when-to-use: "Use BEFORE the first web_search when a single query will not suffice — covers multi-pass strategy, source diversity, and triangulation across results."
metadata:
  flopsy:
    agent-affinity: [saruman, legolas]
---
