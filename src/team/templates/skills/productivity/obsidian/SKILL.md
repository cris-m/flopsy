...
when-to-use: "Use when the user wants to read/write Obsidian vault notes or backlinks."
metadata:
  flopsy:
...
| Quick calculation / one-off | No — ephemeral | write to `/workspace/work/scratch/` |
| Draft note before committing to vault | No — stage first | write to `/workspace/work/docs/`, move to vault when ready |
