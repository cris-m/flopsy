...
when-to-use: "Use when the user wants to do something with Gmail / Drive / Calendar / Contacts / YouTube — covers which per-service MCP to call and the OAuth scope picture."
metadata:
  flopsy:
