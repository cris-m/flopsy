...
when-to-use: "Use when the user wants to add, list, or complete reminders/to-dos on macOS."
category: macos
platforms: [macos]
prerequisites:
  commands: [osascript]
...
## Lessons Learned
- When adding medical or dental appointments to the calendar, check Apple Reminders for potentially duplicate entries on the same date before assuming there's no conflict
