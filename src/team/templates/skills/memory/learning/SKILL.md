...
when-to-use: "Use when the user is in student mode — wants explanations, practice problems, or progressive deepening on a topic — NOT when they want fresh info from the web (use research)."
metadata:
  flopsy:
    agent-affinity: [*]
---
